...
export const CardNav = () => {
  ...
  return (
    <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={{ padding: 3 }}>
      <Card header={HeaderQuiz} style={styles.cardSmall} status='danger' onPress={() => navigation.navigate('Daily', { QuizName: 'DailyQuiz' })}>
        {/* <Text style={{alignSelf:"center"}}>Daily Quiz</Text> */}
        <Image source={quizImg} style={{ width: 200, height: 100 }} />
      </Card>

      <Card header={HeaderAssesment} style={styles.cardSmall} status='success' onPress={() => navigation.navigate('Assessment')}>
        {/* <Text> Check on your Assessment</Text> */}
        <Image source={assessImg} style={{ width: 200, height: 100 }} />
      </Card>

      <Card header={HeaderClosestD} style={styles.cardSmall} status='info' onPress={() => navigation.navigate('Booking')}>
